            ...
            $data = DB::table('types')
              ...
              return Datatables::of($data)
                      ...
                      ->addColumn('action', function($row){
                        ...
                        $btn = '<a href="' . route('types.edit', [$row->id]) . '"
                                 class="edit btn btn-success btn-sm editProduct" title="Módosítás"><i class="glyphicon glyphicon-edit"></i></a>';
                        $btn = $btn.'<a href="' . route('SzotarInsert', [$row->id]) . '"
                             class="btn btn-warning btn-sm SzotarInsert" title="Szótár felvitel"><i class="glyphicon glyphicon-list-alt"></i></a>';
