...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('focsoport', \App\Models\termekfocsoport::where('id', '=', $id)->pluck('nev', 'id')->toArray(), $id,['style' => 'cursor: not-allowed', 'class'=>'select2 form-control', 'readonly' => 'true', 'id' => 'focsoport']) !!}
    {!! Form::label('nev', 'Név:') !!}
