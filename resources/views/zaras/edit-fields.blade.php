...
<div class="form-group col-sm-2">
    ...
    {!! Form::date('datum',  $zaras->datum, ['class' => 'form-control','id'=>'datum']) !!}
    {!! Form::label('kartya', 'myPos:') !!}
    {!! Form::number('kartya', $zaras->kartya, ['class' => 'form-control  text-right', 'id' => 'kartya']) !!}
    {!! Form::label('szep', 'SZÉP kártya:') !!}
    {!! Form::number('szep', $zaras->szep, ['class' => 'form-control  text-right', 'id' => 'szep']) !!}
    ...
    {!! Form::number('napkozben', $zaras->napkozben, ['class'=>'form-control  text-right', 'id' => 'napkozben']) !!}
...
<div class="form-group col-sm-2">
    {!! Form::label('5', '5:') !!}
    {!! Form::number('A5', $zaras->A5, ['class' => 'form-control  text-right', 'id' => 'A5']) !!}
    {!! Form::label('10', '10:') !!}
    {!! Form::number('A10', $zaras->A10, ['class' => 'form-control  text-right', 'id' => 'A10']) !!}
    {!! Form::label('20', '20:') !!}
    {!! Form::number('A20', $zaras->A20, ['class' => 'form-control  text-right', 'id' => 'A20']) !!}
    {!! Form::label('50', '50:') !!}
    {!! Form::number('A50', $zaras->A50, ['class' => 'form-control  text-right', 'id' => 'A50']) !!}
    {!! Form::label('100', '100:') !!}
    {!! Form::number('A100', $zaras->A100, ['class' => 'form-control  text-right', 'id' => 'A100']) !!}
    {!! Form::label('200', '200:') !!}
    {!! Form::number('A200', $zaras->A200, ['class' => 'form-control  text-right', 'id' => 'A200']) !!}
</div>
<div class="form-group col-sm-2">
    {!! Form::label('500', '500:') !!}
    {!! Form::number('A500', $zaras->A500, ['class' => 'form-control  text-right', 'id' => 'A500']) !!}
    {!! Form::label('1000', '1000:') !!}
    {!! Form::number('A1000', $zaras->A1000, ['class' => 'form-control  text-right', 'id' => 'A1000']) !!}
    {!! Form::label('2000', '2000:') !!}
    {!! Form::number('A2000', $zaras->A2000, ['class' => 'form-control  text-right', 'id' => 'A2000']) !!}
    {!! Form::label('5000', '5000:') !!}
    {!! Form::number('A5000', $zaras->A5000, ['class' => 'form-control  text-right', 'id' => 'A5000']) !!}
    {!! Form::label('10000', '10000:') !!}
    {!! Form::number('A10000', $zaras->A10000, ['class' => 'form-control  text-right', 'id' => 'A10000']) !!}
    {!! Form::label('20000', '20000:') !!}
    {!! Form::number('A20000', $zaras->A20000, ['class' => 'form-control  text-right', 'id' => 'A20000']) !!}
</div>
