...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('tipus', [" "] + \App\Models\Type::get()->sortby('nev')->pluck('nev', 'id')->toArray(), $dictionary->tipus,['style' => 'cursor: not-allowed', 'class'=>'select2 form-control', 'readonly' => 'true', 'id' => 'tipus']) !!}
</div>
