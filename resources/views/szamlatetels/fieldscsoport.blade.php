...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('szamla', \App\Models\szamla::where('id', '=', $id)->pluck('szamlaszam', 'id')->toArray(), $id, ['style' => 'cursor: not-allowed', 'class'=>' select2 form-control', 'readonly' => 'true', 'id' => 'szamla']) !!}
    {!! Form::label('termek', 'Termék:') !!}
    {!! Form::select('termek', [" "] + \App\Models\termek::orderBy('nev')->pluck('nev', 'id')->toArray(), null,['class'=>'select2 form-control', 'required' => 'true', 'id' => 'termek']) !!}
