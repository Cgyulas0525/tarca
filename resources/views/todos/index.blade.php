            ...
            <div class="box-body">
                <div class="col-lg-12 col-md-12 col-xs-12">
                    <section class="content-header">
                        <h1><img src="public/img/menu/todo_40.png"> Feladat</h1>
                        <ol class="breadcrumb">
                        <li><a href="{{ route('home') }}"><img src="public/img/menu/dashboard_25.png"> Vezérlő pult</a></li>
                        <li class="active"><img src="public/img/menu/todo_25.png"> Feladat</li>
                        </ol>
                        <form id="header-form" class="form-inline" >
                            <h3 class="pull-right" style="margin-top: -2px;">
                                <a class="btn btn-primary pull-right" title="Felvitel" href="{!! route('todos.create') !!}" style="margin-left: 5px;"><i class="fa fa-plus-square"></i></a>
                            </h3>
                        </form>
                    </section>
    ...
    <script type="text/javascript">
        $(function () {
          ...
          var table = $('.partners-table').DataTable({
              ...
              columns: [
                  {title:  'Akció', data: 'action', sClass: "text-center", name: 'action', width:'130px', orderable: false, searchable: false},
